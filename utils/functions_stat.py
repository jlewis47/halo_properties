...
def density_plot_fancy(stat,nbs,binsx,binsy,xlabel='',ylabel='',cax_label='Counts',xlog=True,ylog=True,collog=True,
    ...
    hist_x_ax.xaxis.set_label_posittion('top')
    ...
    hist_y_ax.set_xticklabels(map(str,y_axis_ticks),rotattion=45)
    ...
    cax.yaxis.set_label_posittion("right")
